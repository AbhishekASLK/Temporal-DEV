...
#             image_data = Image.open(io.BytesIO(response.content)).resize((600, 600))
...
#             default_image = Image.open('assets/images/loader.gif').resize((600, 600))
#             self.image = ImageTk.PhotoImage(default_image)
         
#         # Created the label for image to display on screen
#         self.image_label = tk.CTkLabel(master=self, image=self.image,text="")
...
#         self.heading_label = tk.CTkLabel(master=self, text=self.heading, font=('Verdana', 20,"bold"),wraplength=550, justify='left')
...
#         self.description_label = tk.CTkLabel(master=self, text=self.description, wraplength=550, font=('Verdana', 18), justify='left')
        
#         # Packing it into the screen
#         self.description_label.pack(pady=30)
        
#         # ==================== Navigation Buttons for Items ========================
#         self.bottom_frame = tk.CTkFrame(master=self,height=100,width=300)
#         self.bottom_frame.pack()
        
#         # Prev Button
#         if index !=0:
#             self.prev_btn = tk.CTkButton(self.bottom_frame, text='Prev',width=110,height=70, font=('Verdana', 20, 'bold'),command=lambda:self.newsItem(index-1))
#             self.prev_btn.pack(side='left',padx=30)
        
#         # Read Button
#         if index==0:
#             self.read_btn = tk.CTkButton(self.bottom_frame,text='Read',width=110,height=70, font=('Verdana', 20, 'bold'), command=lambda: self.read_more(self.data['articles'][index]['url']))
#             self.read_btn.pack(side='left',padx=30)
#         elif index>0 and index<len(self.data['articles']):
#             self.read_btn = tk.CTkButton(self.bottom_frame, text='Read',width=110,height=70, font=('Verdana', 20, 'bold'), command=lambda: self.read_more(self.data['articles'][index]['url']))
#             self.read_btn.pack(side='left',padx=30)
#         else:
#             self.read_btn = tk.CTkButton(self.bottom_frame, text='Read',width=110,height=70, font=('Verdana', 20, 'bold'), command=lambda: self.read_more(self.data['articles'][index]['url']))
...
#             self.next_btn = tk.CTkButton(self.bottom_frame, text='Next',width=110,height=70, font=('Verdana', 20, 'bold'), command=lambda: self.newsItem(index+1))
#             self.next_btn.pack(padx=30)
